...
export default class Password extends Component {
  ...
  render() {
    let { inputStyle, labelStyleAdditional,placeholder, inputContainerStyleAdditional } = this.props;
    ...
    return (
      <Input
        ...
        inputContainerStyle={{...inputContainerStyle,...inputContainerStyleAdditional}}
