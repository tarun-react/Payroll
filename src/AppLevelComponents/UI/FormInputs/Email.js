...
HelperMethods.animateLayout()
  ...
  render() {
    let {inputStyle,value,textLabel,placeholder,marginBottom,labelStyleAdditional,inputContainerStyleAdditional} = this.props
    ...
    return (
      <Input
        ...
        inputContainerStyle={{...inputContainerStyle,marginBottom: marginBottom,...inputContainerStyleAdditional}}
