...
export const getAvailableShifts = function() {
  return new Promise(function(resolve,reject) {
      HelperMethods.makeNetworkCall('shift/available',{},(resp, isError) => {
          if (!isError) {
              resolve(resp);
            } else {
              reject(true);
...
export const getShiftTimings = function(date) {
  return new Promise(function(resolve,reject) {
...
export const getDepartments = function() {
  return new Promise(function(resolve,reject) {
      HelperMethods.makeNetworkCall('shift/getAllDepartment',{},(resp, isError) => {
          if (!isError) {
              resolve(resp);
            } else {
              reject(true);
